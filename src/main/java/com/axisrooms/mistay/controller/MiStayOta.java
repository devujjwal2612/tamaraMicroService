package com.axisrooms.mistay.controller;

import com.axisrooms.mistay.manager.OTAManager;
...
public class MiStayOta {
    ...
    @ApiOperation(
            value = "Fetch rooms from mistay ota given a hotelId.",
    ...
    @ApiOperation(
            value = "Fetch Rateplans (Price Configurations) from mistay ota given a hotelId and roomId.",
    ...
    @ApiOperation(
            value = "Updates inventory to mistay ota",
    ...
    @ApiOperation(
            value = "Update rates to mistay ota",
